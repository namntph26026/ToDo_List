    ...
    <div class="content-area" style="position: relative">
            ...
            >
              ...
              <div class="card-footer bg-transparent">
                ...
                <div style="margin-top: 5px">
                  ...
                  <button type="submit" class="btn btn-danger" :style="{background: btnaddtask}" style="border: none;">Add task</button>
                </div>
              </div>
            </div>
          </form>
      ...
      <div class="grid-container todayabc" :style="{ display: todayabc }">
        ...
        >
          <div>
            <img
              src="https://todoist.b-cdn.net/assets/images/d7c6fac19c896959feaaffd6472ca7a0.jpg"
              srcset="
                https://todoist.b-cdn.net/assets/images/6ececcf18613e1109751081be6eda314.jpg 2x,
                https://todoist.b-cdn.net/assets/images/2184637c1a83202f34388cf4c8dabaf3.jpg 3x
              "
            />
            <p class="pyour">What do you need to get done today?</p>
            <p class="pwell">
        ...
        <div class="modal-body">
          <div class="grid-container1">
            <div class="column" style="padding: 15px">
              ...
              >
                <img src="./scr/assets/images/avt.png" />
              ...
              <div :style="{ display: cardDisplay_comment }">
                <form action="" method="POST"  @submit.prevent="updateComment()">
                  <input type="hidden" name="" id="id_comment_edit" v-model="id">
                  <input type="hidden" name="" id="" v-model="id_task">
                  <input type="hidden" name="" id="id_user_edit" v-model="id_user">
                  <textarea name="" id="" cols="30" rows="2" v-model="comment_text"></textarea>
                  <!-- <input type="text" name="" id="" > -->
                  <br>
                  <button type="submit" class="btn btn-primary">Sửa comment</button>
                </form>
              </div>
                  ...
                  >
                    <div class="form-check">
                      ...
                      <div class="formboxtoday1">
                        <input type="hidden" name="" id="" v-model="id_task_add" />
                        <textarea
                          name="comment_text"
                          id="comment-text"
                          cols="30"
...
export default defineComponent({
  setup() {
    ...
    function toggleCard_eidt() {
      cardDisplay_edit.value = cardDisplay_edit.value === "block" ? "none" : "block";
      todayabc.value = todayabc.value === "none" ? "block" : "none";
    }
    ...
    const getTasks = () => {
      const token = localStorage .getItem("token");
      axios
        .get("http://127.0.0.1:8000/api/listdate", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
      ...
      axios
        ...
        .then((response) => {
          ...
          if (!response.data.id_project) {
            ...
            taskedit.id_project = response.data.id_project;
          }
        })
        .catch((error) => {
          console.log(error);
    ...
    const deltail = () => {
      ...
      axios
        ...
        .then((response) => {
          ...
          taskedeltail.task_description_deltail = response.data.task_description;
    ...
    const updateComment =  () => {
      ...
      axios
        .put(`http://127.0.0.1:8000/api/comment/update/${commentID_edit}`,commentedit,{
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
