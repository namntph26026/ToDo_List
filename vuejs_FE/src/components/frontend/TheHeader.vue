<template>
  <div class="container-fluid" style="position: relative">
    <header style="position: relative">
      <nav class="navbar navbar-expand-lg navbar-light fixed-menu">
        <div class="container-fluid">
          <div class="navbar-left">
            <router-link :to="{ name: 'frontend-home' }">
              <a class="navbar-brand" href="#">
                <div class="JDguX5oZL3ITNTthPuWx">
                  <svg
          ...
          <div class="navbar-right">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <router-link :to="{ path: 'login' }">
                  <li class="nav-item">
                    <a class="nav-link" aria-disabled="true" href="#">
                      <button type="button" class="btnnav btn">Login</button></a
                    >
                  </li></router-link
                >
                ...
                <li class="nav-item">
                  <a class="nav-link" aria-disabled="true" href="/dangky">
                    <button type="button" class="btnnav btn btn-danger">
                      Register
                    </button></a
                  >
                </li>
              ...
              <!-- <form class="d-flex" role="search">
                                    <button type="button" class="btnnav btn btn-secondary">Mon Todoist</button>
                                    <button type="button" class="btnnav btn btn-secondary">Mon Todoist</button>
                                </form> -->
            </div>
          </div>
